...
description: "A coffee-chat guide from outcome types (continuous, binary, count, survival) to common R functions. The daughter learns how endpoints shape analysis choices."
tags:
  - Language & writing
  - Probability model
  - R simulation
