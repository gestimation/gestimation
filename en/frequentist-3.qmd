...
::::::::::::::::::::::::::::::::: dialogue
::: voice-daughter
Daughter: "I'm home, dad. It's about time we got the down jackets out. Oh—can I have a hot coffee?"
:::

::: voice-father
Dad: "I figured you'd be back soon, so I made plenty. Hey—remember when we talked about survival curves and p-values in the JCOG9502 paper (Sasako et al. 2006)? Something stayed with me. Why do people say, 'if the p-value is less than 0.05, it's statistically significant'?"
:::
...
::: voice-father
Dad: "That's a common way of *reading papers*—and it's the wrong one here. Let me ask you: when you read a paper, you start with the Abstract. Then what do you read next?"
:::
...
::: voice-father
Dad: "I get that. But when it comes to p-values, if you want a correct interpretation, you need to read the Methods first. People have worried for a long time that p-values are widely misunderstood in the scientific community. The American Statistical Association (ASA) even issued a statement aimed at researchers who aren't statisticians, practitioners, and science writers. One trigger was a post like this, submitted to an ASA forum in February 2014."
:::
...
::: voice-father
Dad: "And the ASA summarized six principles about how p-values should be used."
:::
::::::::::::::::::::::::::::::::: 
...
::: voice-father
Dad: "Right. In an ideal world, alpha is the textbook 0.05. And you're not supposed to change alpha mid-trial. Everyone knows that. But when accrual stalls, sometimes the trial has to be adjusted to stay interpretable. That seems to be what happened here: they loosened alpha to 0.1 as a last resort."
:::

::: voice-daughter
Daughter: "I skipped right past that. JCOG is... surprisingly flexible."
:::
...
In 2016, the American Statistical Association (ASA) summarized six principles to improve the practice and interpretation of quantitative research (Wasserstein and Lazar 2016). They are listed below.
