...
::: {.callout-note appearance="simple" title="Kaplan-Meier curve for overall survival (OS)"}
...
::: {.callout-note appearance="simple" title="Kaplan-Meier curve for relapse-free survival (RFS)"}
...
::: {.callout-note appearance="simple" title="Aalen-Johansen curve for cumulative incidence of relapse (CIR)"}
