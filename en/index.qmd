...
Each episode can be read on its own, but the conversations gently build from there. Some episodes include short R scripts—not to teach programming, but to help you feel how causal questions and statistical assumptions take shape in data.

You can read in order or jump to any layer that interests you. If you read through the whole series, the scattered pieces will slowly find their places—and the view may look a little different than before.
