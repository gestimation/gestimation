...
::: {.callout-note appearance="simple"  title="Handling survival data in R"}
...
| Continuous        | Yes                     | Yes          | Random-effects model, GEE              |
| Binary            | No                      | No           | $\chi^2$ test                          |
| Binary            | No                      | Yes          | Logistic regression                    |
| Binary            | Yes                     | Yes          | Random-effects logistic, GEE           |
| Count             | No                      | Yes          | Poisson regression                     |
| Survival          | No                      | No           | Kaplan–Meier curve                     |
| Survival          | No                      | Yes          | Cox regression                         |
| Competing risks   | No                      | No           | Aalen–Johansen curve                   |
...
3. When the censoring proportions of two groups do not differ significantly in a hypothesis test.  
