...
::: {.callout-note appearance="simple" collapse="true" title="A cautionary tale: Hopate"}
...
::: {.callout-note appearance="simple" collapse="true" title="R code for coxph() and outout"}
```{r warning=FALSE}
