...
- Survival time data: there’s no single standard, but a simple one is the exponential distribution.
...
- Proportion: a parameter of a *binomial* distribution  
- Rate: a parameter of a *Poisson* distribution.
