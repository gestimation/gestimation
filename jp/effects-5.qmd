...
::::::::::::::::::::::::::::::::: dialogue
::: voice-daughter
私「お父さんさ、以前聞いた寄与割合の話を思い返して気づいたんだけどね。またわからないことがあるんだ」
:::
...
::: voice-father
お父さん「えーっと、リスク比が変化しないわけじゃなくて...。ちょっとナプキンとペンをとってくれる？教科書通りに説明するとこうなるんだけど。まずはリスクとハザードからはじめるね」
:::
:::::::::::::::::::::::::::::::::



::: {.callout-note title="生存曲線とハザードの関係"}
...
::: {.callout-note title="ハザードと生存時間中央値の関係"}
...
::: voice-father
お父さん「そうだね、指数分布の下で計算すると、だけどね。ハザード比は、まさにハザードの比をとることで、2つの集団の生存曲線を比較する指標なんだ」
:::
::::::::::::::::::::::::::::::::: 


::: {.callout-note title="リスクとハザード比の関係"}
...
::: {.callout-note title="シミュレーションデータにおける時点ごとのリスク比の推定"}
...
::: voice-father
父「だってそうでしょ？効果って時間とともに生じるものだもの。それが因果の定義のひとつでもある」
:::
