...
Keywords: simulation, study design, survival/competing-risk
:::
...
::: voice-father
父「生存曲線の形は指数分布で決める。途中で追跡できなかった患者は打ち切り扱いになるけど、それも指数分布で発生させる。この設定だと、Cox回帰の仮定はすべて正しい。だから理論的にcoverageは95%になるはず」
:::
...
::::::::::::::::::::::::::::::::: dialogue
::: voice-daughter
私「だいたいcoverageが95%になるっていうのはわかった。でも結局、“95%信頼区間”ってどう理解すればいいの？」
:::
