...
- Volatility（変動性）: 生存時間解析・競合リスク解析、中間解析、効果安全性評価委員会
- Uncertainty（不確実性）: p値、信頼区間、サンプルサイズ設計、確率モデル
- Complexity（複雑性）: ランダム化、シミュレーション、変数選択、DAG
- Ambiguity（曖昧性）: 定義、言語、研究計画書（プロトコール）、仮定の明示、因果モデル
