---
title: "Why My Logistic Regression Calculation Went Wrong"
format:
  html:
    toc: true
---
...
# Adjusting for bias IV − Why My Logistic Regression Calculation Went Wrong
...
- [From 2×2 Tables to Logistic Regression](logistic-regression-1.qmd)
- [How to Read Logistic Regression Coefficients](logistic-regression-2.qmd)
- [Pitfalls of Logistic Regression with Small Samples](logistic-regression-3.qmd)
- [Why My Logistic Regression Calculation Went Wrong](logistic-regression-4.qmd)
- [Simpson's paradox](logistic-regression-5.qmd)
