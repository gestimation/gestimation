...
::: voice-daughter
私「情報が偏ったらバイアスっていうのはわかるけど。死亡が特定できないのはどうしようもないときだもの。ベストを尽くすしかないよね。じゃあさ、私の調査で、それ以外に気をつけておいた方がいいバイアスってある？」
:::

::: voice-father
お父さん「そうだね。調査票を郵送するんでしょ。そういうとき、**回答してくれない患者が多いと偏りが生じやすい**から、回答率を挙げる工夫をするといい。たとえば、調査票で年収って聞いてる？」
:::
...
::: voice-father
お父さん「イベントと競合リスクの扱いによってバイアスが生じるってことをみせてあげるよ。前に使ったRスクリプトをいじるだけですぐ終わるから。論より証拠で、シミュレーションデータをみれば統計的なバイアスってどんなものか実感できる」
:::
:::::::::::::::::::::::::::::::::
...
::::::::::::::::::::::::::::::::: dialogue
::: voice-father
お父さん「わかった？シミュレーションで使った確率分布は、研究でなにが起きるかを抽象化した数理モデルなんだ。どんな統計手法も使用条件みたいなものがあって、前提にしている数理モデルからずれるとバイアスが生じる。モデルの誤特定なんて言い方をするね」
:::

::: voice-daughter
私「なるほどね。再発確率と死亡確率の和が1を超えることはあり得ないよ、Kaplan–Meier曲線にバイアスが生じていることの証拠だよっていいたいのね。でも、こんなマニアックなバイアスじゃなくて、調査を行う上で何に注意した方がいいか聞いたつもりだったんだけど」
:::
::::::::::::::::::::::::::::::::: 
