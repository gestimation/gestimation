...
::: voice-daughter
私「情報が偏ったらバイアスっていうのはわかるけど。死亡が特定できないのはどうしようもないときだもの。ベストを尽くすしかないよね。私の調査で、それ以外に気をつけておいた方がいいバイアスってある？」
:::
...
::: voice-father
お父さん「前に使ったRスクリプトをいじるだけですぐ終わるから。シミュレーションデータでバイアスを見せてあげるよ」
:::
:::::::::::::::::::::::::::::::::
