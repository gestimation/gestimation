---
title: "Common Causes and Confounders"
format:
  html:
    toc: true
---
...
# Causal inference II − Common Causes and Confounders
...
::: voice-father
お父さん「じゃあ変数を5つに増やした例を使って、もう少し正式に解説してみようか」
:::
::::::::::::::::::::::::::::::::: dialogue
...
::: voice-father
お父さん「それは、DAGにおいて、ブロックされていないパスは、**有向パス**と共有原因を経由する**バックドアパス**の2種類しかありえないってこと」
:::
