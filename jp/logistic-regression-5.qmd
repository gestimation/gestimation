...
::::::::::::::::::::::::::::::::: dialogue
::: voice-daughter
私「お父さん、ロジスティック回帰でわからないことがあるんだけど。以前、観察研究では**交絡因子（confounder）**を調整しないといけない、とかいってたよね」
::: 
...
::: voice-daughter
私「交絡調整について解説してくれない？統計学の本を読んでも、書いてなくて」
::: 

::: voice-father
お父さん「じゃあちょっと時間をかけて説明させてよ。」
:::
...
::: voice-father
お父さん「そういうこと。これが疫学でいう交絡因子。交絡因子を調整したときとしないときで、まったく違った結果が得られるっていう数値例を示そう」
:::
:::::::::::::::::::::::::::::::::
...
::::::::::::::::::::::::::::::::: dialogue
::: voice-daughter
私「単純な解析ではコーヒーはリスク因子なのに、層別しただけで関連が消えた。バイアスがあるんでしょとは思ったけど...“計算上のトリック”じゃなくて、何が起きてるの？あれ？ちょっと前こうやって雑談してたとき、オッズ比は層別すると数値が安定しないっていってたっけ？そのせい？」
::: 

::: voice-father
お父さん「うん、オッズ比は層別したら値が変わりやすい、**併合可能ではない（non-collapsible）**指標だね。それもあるんだけど、ほとんどの観察研究で、交絡の影響は、効果の指標の違いよりずっと大きいんだ。それに、層別オッズ比ではなく、一般化線型モデルでもほぼ同じ結果になる。確かめてみようか」
::: 
:::::::::::::::::::::::::::::::::
...
::::::::::::::::::::::::::::::::: dialogue
::: voice-father
お父さん「どういうとき、調整前後で効果の値が変わるか、その条件を知りたい？」
::: 

::: voice-daughter
私「それ聞く？同じデータなのに解析方法によってオッズ比が1になるのは不思議だもの、決まってるでしょ」
::: 

::: voice-father
お父さん「じゃあ説明するね。まず前提になるのが、喫煙が膵がんのリスク因子だってこと。これはいいよね」
::: 
...
::: voice-father
お父さん「うん、喫煙群と非喫煙群でコーヒー摂取割合に大きな差があるでしょ。この現象が起きた理由は、コーヒー摂取と喫煙に強い関連があったため、ということ。これは、当時、たばこを吸いながらコーヒーを飲んでいたことを表している」
::: 

::: voice-daughter
私「時代を感じるね、仕事終わったらくつろぎたい気持ちはめっちゃわかる」
::: 

::: voice-father
お父さん「まとめると、ポイントは3つの変数の相関関係なんだ。第3の因子と曝露に相関があり、さらに第3の因子とアウトカムにも相関があるとき、Simpsonのパラドックスが起きる。正確にいうと、これは十分条件で必要条件じゃないんだけどね（田中2022）」
::: 

::: voice-daughter
私「曝露とアウトカムと第3の変数の関係性ねえ。交絡の話ってまあまあややこしいね」
::: 

::: voice-father
お父さん「交絡って、言葉自体になじみがないこともあって複雑に思うだろうけど、実際の研究ではもっとシンプルに考えることもできる。研究の原則としてときどき使う"ceteris paribus"というラテン語があってね。"All other things being equal"くらいの意味なんだけど、比較する集団で条件をそろえたら、交絡によるバイアスは生じない」
::: 

::: voice-daughter
私「ふーん。まってね、さっきの条件を確認する。コーヒー摂取群とコーヒー非摂取群で、喫煙率が違う。さらに喫煙は膵がんリスクも上げる。そうすると層別したらオッズ比の値が変わった。ああ、もともとバイアスが入ってたんだから、調整して値が変わるのは当然か」
::: 

### Simpsonのパラドックスと交絡は同じじゃない？

::: voice-father
お父さん「表の意味はそういうことだね。でもね、正確にいうとSimpsonのパラドックスと交絡は、数学的には異なる現象なんだ。きちんと統計的に定式化して考えると、交絡はそんなに単純な問題じゃない。簡単にいうとね。層別前の解析は集団全体のオッズ比でしょ」
::: 
...
::: voice-father
お父さん「うん。この具体例では喫煙は交絡因子なのは間違いないんだよ。でも一般には、層別前と層別後のどっちのオッズ比が真値なのか、統計学の枠組みで決めるロジックはないんだ。データがどんな確率分布に従っているか、誰も知らないからね」
::: 
