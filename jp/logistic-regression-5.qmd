...
::::::::::::::::::::::::::::::::: dialogue
::: voice-daughter
私「へー。単純な解析ではコーヒーはリスク因子なのに、層別しただけで関連が消えた。バイアスがあるんでしょとは思ったけど、こんなことあるんだ。あれ？ちょっと前こうやって雑談してたとき、オッズ比は層別すると数値が安定しないっていってたっけ？そのせい？」
::: 

::: voice-father
お父さん「うん、オッズ比は併合可能ではない、non-collapsibleな指標だね。それもあるんだけど、観察研究のほとんどで、交絡の影響は、効果の指標の違いよりずっと大きいんだ」
::: 

::: voice-daughter
私「ふむふむ、ってことは、層別解析じゃなくてロジスティック回帰を使わないとだめって話だっけ？」
::: 

::: voice-father
お父さん「ううん、層別でもロジスティックでもいいんだけど、喫煙を調整しないといけないって話。実際解析してみると、どっちでもほぼ同じ結果になる。確かめてみようか」
::: 
:::::::::::::::::::::::::::::::::
...
::: voice-daughter
私「そりゃあね。解析方法によってオッズ比が1になるのは不思議だもの」
::: 
...
::: voice-father
お父さん「まとめると、ポイントは3つの変数の相関関係なんだ。第3の因子と曝露に相関があり、さらに第3の因子とアウトカムにも相関があるとき、Simpsonのパラドックスが起きる」
::: 

::: voice-daughter
私「Simpsonのパラドックスねえ。交絡ってまあまあややこしいね」
::: 

::: voice-father
お父さん「交絡は言葉自体になじみがないからそう思うだろうけど、もっとシンプルに考えることもできる。研究の原則としてときどき使う"ceteris paribus"というラテン語があってね。"All other things being equal"くらいの意味なんだけど、比較する集団で条件をそろえたら、交絡によるバイアスは生じない」
::: 
...
::: voice-father
お父さん「表の意味はそういうことだね。でもね、正確にいうとSimpsonのパラドックスと交絡は、同じ現象じゃない。きちんと統計的に定式化して考えると、交絡はそんなに単純な問題じゃないんだ。層別前の解析は集団全体のオッズ比でしょ」
::: 
...
::: voice-father
お父さん「うん。このケースでは喫煙は交絡因子なのは間違いないんだよ。でも、統計学の枠組みで、層別前と層別後のどっちのオッズ比が真値なのか、決めるロジックはないんだ。データがどんな確率分布に従っているか、誰も知らないからね」
::: 
