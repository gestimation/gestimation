...
::: voice-father
お父さん「ああ、ありがとう。おいしいね。ワクチンとは別の話題なんだけど、喫煙歴のあるがんの患者さんって、減ったと思う？」
:::
...
::: {.callout-note appearance="simple"  title="寄与割合とその関連指標1"}
...
あるリスク因子が国民全体の疾患発症にどの程度寄与するかを反映する指標は、population attributable fractionと呼ばれています。$RR$はリスク比、$p$は集団全体のうち群1が占める割合を意味しています。
ここで$RR$はリスク比、$p$は集団全体のうち群1が占める割合を意味しています。
...
::: {.callout-note appearance="simple"  title="寄与割合とその関連指標2"}
...
::: voice-father
お父さん「そうだよね。あのね、疾患リスクで考えるから混乱しがちなのかもしれない。たとえ話をさせてよ。60歳になってがん検診にきた人が4人いたとする。話をわかりやすくするために、4人の健康状態はまったく同じだとしよう。そのうち、最初の2人はがん検診が陽性で、根治切除できたとする。その後、71歳と79歳まで生きることができた。つまり、がん検診後の生存期間は11年と19年」
:::
