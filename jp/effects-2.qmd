...
:::
# Story and Quiz − Effects and time II
...
また、excess fractionのターゲット集団を群1から集団全体（群1+群2）にした指標は、population attributable fractionと呼ばれています。$RR$はリスク比、$p$は集団全体のうち群1が占める割合を意味しています。
...
| 指標 | ターゲット集団 | 何を表す？ | いつ使う？ |
|------|------|---------------------------|-------------|------------|
| Excess fraction（寄与割合） | **曝露だけ** | 曝露集団のうち、どれだけの割合が曝露のため疾患を生じたか | 喫煙、飲酒、化学物質などの有害曝露の個人への影響を知りたいとき |
| Preventable fraction（予防寄与割合） | **曝露だけ** | 曝露集団のうち、どれだけ予防的な曝露が疾患を防いだか | ワクチン・検診・運動などの予防法が、個人のリスクをどれだけ下げたか知りたいとき |
| Population attributable fraction（集団寄与割合） | **曝露+非曝露** | 集団全体の疾患のうち、どれだけがその曝露のため生じているか | 公衆衛生・医療政策で、曝露をなくせば集団でどれだけ減るかを評価するとき |
:::
...
寄与割合は、excess fractionやpreventable fraction以外に、曝露・非曝露を合わせた集団全体をターゲットにすることもあります（population attributable fraction）。先ほど用いたがん検診の例で考えましょう。仮にがん検診の精度が高くなって、感度を100%にできたとしましょう。先ほどの状況（感度50%）に比べて、検診後15年後に死亡している人数は、4人のうち、どのくらい減ると期待されるでしょうか。
...
この計算は、集団全体をターゲットとする寄与割合を求めていることに他なりません。集団全体における曝露割合を$p$で書くと、population attributable fractionは、以下の式で表されます。
