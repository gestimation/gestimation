...
::::::::::::::::::::::::::::::::: dialogue
::: voice-daughter
私「ナプキンに描いてくれた表自体はわかるんだけどね。そこからαとかβとか確率とかいわれてもなあ。ついていけないな」
:::
...
powerSurvEpiパッケージで、あの表とほぼ同じ計算ができるはず。割付け比を、1:1から2:1、4:1に変えて、ストーマ保有者が33%、20%のときの計算をしてみよう」
:::

:::::::::::::::::::::::::::::::::

::: {.callout-note title="Rパッケージを用いたサンプルサイズ設計"}
...
::::::::::::::::::::::::::::::::: dialogue
::: voice-father
お父さん「割付け比Kが1（1:1）、0.5（2:1）、0.25（4:1）だと、必要サンプルサイズ（nE+nC）は100+100人から19+118人、41+161人に変化するみたいだね」
:::
...
::: voice-father
お父さん「気持ちはわかるよ。真剣に研究をデザインすると、だいたい最初は“そんなに集められないよ”って顔になるからね」
:::
:::::::::::::::::::::::::::::::::
