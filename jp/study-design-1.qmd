...
::: voice-father
お父さん「うんうん。大学の授業だとね、研究で調べたい疑問がはっきりしないなら、"PICO"と"PECO"という要素を使って、研究をデザインしなさいって教えてるよ。研究の構造化ってやつ」
:::
...
::: voice-father
お父さん「じゃあ軽く整理しよう。たとえばPICO/PECOのPは、患者（Patients）または集団（Population）の頭文字で、研究デザインの大切な1要素だってこと」
:::

::: voice-daughter
私「Patientsはわかるよ。それ以外は？」
:::

::: voice-father
お父さん「Pと同様に大切な、I/E（Intervention/Exposure）、C（Comparison）、O（Outcome）をあわせた4つの要素にあてはめて考えてみましょう、というわけ」
:::
