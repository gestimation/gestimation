...
Keywords: causal model, clinical trial, generalized linear model, observational study, study design
:::
...
- [Outcomes: The Bridge from Data Collection to Analysis](study-design-4.html)
