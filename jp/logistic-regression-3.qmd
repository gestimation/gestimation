...
:::
# Story and Quiz − Adjusting for bias III
...
::::::::::::::::::::::::::::::::: dialogue
::: voice-father
お父さん「この表は間違いじゃないんだけどもっとよくできる。表を作成するときには、情報が自然に入ってくるように、読者の立場で考えなくちゃ。具体的な注意点はこんなところかな」
:::
:::::::::::::::::::::::::::::::::
...
::: {.callout-note appearance="simple" title="注意事項1. フォーマット"}
...
::: {.callout-note appearance="simple" title="注意事項2. 単位・表示桁数"}
...
::: {.callout-note appearance="simple"  title="注意事項3. 表タイトル・脚注"}
...
::: {.callout-note appearance="simple"  title="注意事項4. 数え尽くしの原則"}
